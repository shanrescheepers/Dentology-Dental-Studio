...
medAidNum
 ...
 <?php
    ...
    $sql = "INSERT INTO patient ( name, surname, age, genderId, email, password, profileImage, phone, medAidNum) VALUES( :name, :surname, :age, :genderId, :email, :password, :profileImage, :phone, :medAidNum)";
