<?php
    ...
    $sql = "UPDATE patient SET name= :name, surname= :surname,  age= :age, genderId= :genderId, email= :email, password= :password, profileImage= :profileImage, phone= :phone,   medAidNum= :medAidNum WHERE patientId= :patientId";
