<?php
    ...
    $sql = "UPDATE doctor SET name= :name, surname= :surname, genderId= :genderId, profileImage= :profileImage, age= :age, phone= :phone, email= :email, spesId= :spesId WHERE doctorId= :doctorId";
