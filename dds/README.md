...
6. Make sure the SQL file and PHP files are extracted and put into your MAMP/WAMP htdocs file and corresponds with the MySQL database running either using MAMP or WAMP</br>
